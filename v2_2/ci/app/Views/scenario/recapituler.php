...
<table>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                <a style="border-bottom: none;" target="blank" href="<?= url_to('scenario#detail', $scenario['sce_code']) ?>"><img width="18em" src="<?= base_url() . "images/see.svg" ?>" alt="Visualiser" title="Visualiser"/></a>
